...
The generated site is a single page with your README content, no sidebar, and a table of contents on the right. If you provide `--repo`, a "Source code" link will appear in the footer.
...
| `--repo` | URL to the original repository | No |
